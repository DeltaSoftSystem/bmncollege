...
//print_r($wti_cms_exam_continuous_temp);
...
?>
                            ...
                            <ul class="dropdown">
                                <li><a href="#"><?php echo $this->lang->line("Undergraduate");?></a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="foundation-programm">Foundational Courses </a></li>
                                    </ul>
                                </li>
 ...
 <li><a href="#" target="_blank">Academic Audit </a>
                                        ...
                                        <li><a href="#"><?php echo $this->lang->line("Perspective Plan");?></a>
                                            <ul class="dropdown">
                                        ...
                                        <li><a href="#"><?php echo $this->lang->line("Feedback");?></a>
                                            <ul class="dropdown">
                                                <li><a href="<?php echo base_url();?>uploads/pdf/student-satisfaction-survey.pdf"
                                                        target="_blank"><?php echo $this->lang->line("Student Satisfaction Survey");?> </a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a href="#"><?php echo $this->lang->line("ICT Tools");?></a>
                                            <ul class="dropdown">
                                                <li><a href="<?php echo base_url();?>uploads/pdf/ICT-tools.pdf"
                                                        target="_blank"><?php echo $this->lang->line("ICT Tools");?> </a></li>
                                            </ul>
                                        </li>
                        ...
                        <li class="<?php echo (in_array($page_url,$Committees)) ? 'active' : ''?>"><a href="#"><?php echo $this->lang->line("COMMITTEES");?></a>
                            <ul class="dropdown">
                                ...
                                <li><a href="#"><?php echo $this->lang->line("College Level");?> </a>
                                    <ul class="dropdown">
                                        <li><a href="<?php echo base_url();?>uploads/pdf/College Committees 2021 - 2024.pdf"  target="_blank"><?php echo $this->lang->line("Committee List");?></a></li>
                                 ...
                                 <li><a href="<?php echo base_url();?>uploads/pdf/ANTI-RAGGING COMMITTEE.pdf"  target="_blank">ANTI-RAGGING</a>
                        ...
                        <li class="<?php echo (in_array($page_url,$contactus)) ? 'active' : ''?>"><a href="contact-us"><?php echo $this->lang->line("CONTACT US");?></a></li>
                    </ul>
                </div>
            </div>
        </div>
