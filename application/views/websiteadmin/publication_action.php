                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="group_name">For :</label>
                                <div class="col-lg-9">
                                    <?php
                                    $degree_year_master[]='Student Publication';
                                    $degree_year_master[]='Teachers Publication';
                                    ?>
                                    <select name="group_name" id="group_name" class="form-control" aria-label="Default select" required>
                                        <option value="">Select</option>
                                        <?php
                                        foreach($degree_year_master as $key => $value) {
                                        ?>
                                        <option value="<?php echo $value?>" <?php echo (isset($records['group_name']) && $records['group_name']==$value) ? ' selected' : ''?>><?php echo $value?></option>
                                         <?php }?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="name">Title <span
                            ...
                            <div class="form-group row">
                                ...
                                $pdf_file = (isset($records['pdf_file']) && $records['pdf_file']!="") ? base_url()."uploads/cms/publication/".$records['pdf_file'] : '' ;
                                                if($pdf_file!=""){
                              ?>
