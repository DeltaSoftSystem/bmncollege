                                ...
                                <tbody>
                                    <?php
                                     ...
                                     <tr class="  border-left-3">
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo strtoupper($this->common->getDbValue($value['exam_name'])); ?></td>
                                        <td><?php echo $this->common->getDbValue($value['tab_name']); ?></td>
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        ...
                        location.href = "<?php echo site_url($controller . '/delete_resulttab/'.$degree_name.'/') ?>" + uuid;
