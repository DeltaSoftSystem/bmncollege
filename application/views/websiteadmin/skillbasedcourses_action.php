                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="heading">Heading <span
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="descriptions">Label <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control alhanumeric1 "
                                         name="descriptions" id="descriptions"
                                        value="<?php echo isset($records['descriptions']) ? $records['descriptions']  : ''; ?>"
                                        placeholder="Label">
                                </div>
