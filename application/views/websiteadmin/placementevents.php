                                ...
                                <tbody>
                                    <?php
                                     ...
                                     <tr class="  border-left-3  <?php echo ($status == "Active") ? 'border-left-success' : 'border-left-danger' ?>  tr<?php echo $this->common->getDbValue($value['status_flag']); ?>">
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $this->common->getDbValue($value['descriptions']); ?></td>
                                        <td><?php echo isset($value['event_dates_from']) ? $this->common->getDateFormat($value['event_dates_from'], DATE_FORMAT_PHP) : ''; ?>  <?php echo (!empty($value['event_dates_to'])) ? ' to '.$this->common->getDateFormat($value['event_dates_to'], DATE_FORMAT_PHP) : ''; ?></td>
                                        <td> 
                                            <?php
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        ...
                        location.href = "<?php echo site_url($controller . '/delete_data_placementevents/'.$data_type) ?>/" + uuid;
