                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="heading">Title/Heading <span
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="location">Location <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control alhanumeric1 maxlength-textarea"
                                        maxlength="150" name="location" id="location"
                                        value="<?php echo isset($records['location']) ? $records['location'] : ''; ?>"
                                        placeholder="Location">
                                    <span class="form-text text-muted">BMN College</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="event_dates">Date <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-2"><?php //print_r($records);?>
                                ...
                                <label class="col-lg-1 col-form-label text-right" for="event_time">Time <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-2">
                                    <input type="text" class="form-control pickatime  "
                                         name="event_time" id="event_time"
                                        value="<?php echo isset($records['event_time']) ? $records['event_time'] : ''; ?>"
                                        placeholder="Time">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <textarea name="descriptions" id="descriptions"
                                        class="form-control summernote1"><?php echo isset($records['descriptions']) ? $records['descriptions'] : ''; ?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <div class="row col-md-5">
                                        <img src="<?php echo $featured_image?>" id="temppreviewimageki1"
...
$(document).ready(function() {
    ...
    $("#blogform1").submit(function(e) {
        ...
        if (!$("#event_time").val()) {
            isError = true;
            $("#event_time").addClass("border-danger");
