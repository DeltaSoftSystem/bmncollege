                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                    <label class="col-lg-2 col-form-label">Form Url(Google) <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <?php
                                     //  print_r($records);
                                        ?>
                                        <input type="text" class="form-control" name="feedbackform" id="feedbackform" value="<?php echo isset($records['value']) ? $records['value'] : ''; ?>" placeholder="https://forms.gle/3NutdjqFhoRgXcsbA" required>
