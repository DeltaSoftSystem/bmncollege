                                ...
                                <tbody>
                                    <?php
                                     ...
                                     <tr class="  border-left-3  <?php echo ($status == "1") ? 'border-left-success' : 'border-left-danger' ?>  tr<?php echo $this->common->getDbValue($value['status_flag']); ?>">
                                        <td><?php echo $i; ?></td>
                                        <td><?php if($value['slider_image']!=''){
			  	$photo = base_url() . '/uploads/gallery/'.stripslashes($value['slider_image']);
?>
                                        <img src="<?php echo $photo?>" alt="" style="width:100px; height:auto;display:none1"  />
                                        <?php } else { ?>
                                       ...
                                       <td><?php echo $this->common->getDbValue($value['slider_text']); ?></br><?php echo $this->common->getDbValue($value['alumnae_type']); ?></td>   
                                       <?php
                                        if($gallery_type!="recruiters"){
                                        ?>  
                                       ...
                                       <?php }?>
                                        <td> 
                                            <?php
if ($status == "1") {echo '<span class="badge badge-success  w-1001">Active</span>';}
      ?>
                                            <?php
if ($status != "1") {echo '<span class="badge badge-danger  w-1001">Inactive</span>';}
      ?></td>
                                        <td><a href="<?php echo site_url($edit_link.'/'.$value['slider_id'])?>" class="list-icons-item text-primary-600" data-popup="tooltip" title="Edit" data-container="body"><i class="icon-pencil7"></i></a>
                                            <a href="#" data-uuid="<?php echo $value['slider_id'] ?>" class="list-icons-item text-danger-600 bootbox_custom" data-popup="tooltip" title="Delete" data-container="body"><i class="icon-trash"></i></a>
                        ...
                        <?php }   else {
                                ?>
                        <div class="row">
                            <div class="col-xl-12 text-center p-lg-5  "> No record found
                            </div>
                        </div>
                        <?php   
                                       }?>
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        ...
                        location.href = "<?php echo site_url($controller . '/delete_data/'.$gallery_type.'/') ?>" + uuid;
