                                ...
                                <tbody>
                                    <?php
                                      ...
                                      foreach($results as $key => $value){
                                          $i++;
                                          $status = 1;//$this->common->getDbValue($value['status_flag']);

                                           $pdf_file = (isset($value['pdf_file']) && $value['pdf_file']!="") ? base_url()."uploads/cms/result/".$value['pdf_file'] : '' ;
                                     ...
                                     <tr class="  border-left-3  <?php echo ($status == "1") ? 'border-left-success' : 'border-left-danger' ?>  tr<?php echo $this->common->getDbValue($value['status_flag']); ?>">
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $this->common->getDbValue($value['degree_year']); ?></td>
                                        <td><?php echo $this->common->getDbValue($value['semester']); ?></td>
                                        <td><a href="<?php echo $pdf_file?>" target="_blank"><?php echo $this->common->getDbValue($value['pdf_file']); ?></a></td>
                                        <td><a href="<?php echo site_url($edit_link.'/'.$value['id'])?>" class="list-icons-item text-primary-600" data-popup="tooltip" title="Edit" data-container="body"><i class="icon-pencil7"></i></a>
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        ...
                        location.href = "<?php echo site_url($controller . '/delete_data_result/'.$degree_name.'/') ?>" + uuid;
