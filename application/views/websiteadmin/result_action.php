                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="degree_year">For Year :</label>
                                <div class="col-lg-9">
                                    <select name="degree_year" id="degree_year" class="form-control" aria-label="Default select" required>
                                        <option value="">Select</option>
                                        <?php
                                        foreach($degree_year_master as $key => $value) {
                                        ?>
                                        <option value="<?php echo $value?>" <?php echo (isset($records['degree_year']) && $records['degree_year']==$value) ? ' selected' : ''?>><?php echo $value?></option>
                                         <?php }?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="semester">Semester <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control alhanumeric1 "
                                         name="semester" id="semester"
                                        value="<?php echo isset($records['semester']) ? $records['semester']  : ''; ?>"
                                        placeholder="Sem II Result" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                $pdf_file = (isset($records['pdf_file']) && $records['pdf_file']!="") ? base_url()."uploads/cms/result/".$records['pdf_file'] : '' ;
                                                if($pdf_file!=""){
                              ?>
...
$(document).ready(function() {
    ...
    $("#blogform1").submit(function(e) {
        ...
        if (!$("#degree_year").val()) {
            isError = true;
            $("#degree_year").addClass("border-danger");
