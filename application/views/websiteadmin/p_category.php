                    ...
                    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                        ...
                        <div class="header-elements d-none">
                            <div class="breadcrumb justify-content-center">
                                <a href="<?php echo site_url($controller . "/categor_action"); ?>" class="breadcrumb-elements-item">
                                ...
                                <tbody>
                                    <?php
                                     ...
                                     <tr class="  border-left-3  <?php echo ($status == "1") ? 'border-left-success' : 'border-left-danger' ?>  tr<?php echo $this->common->getDbValue($value['status_flag']); ?>">
                                        ...
                                        <td><img src="<?php echo base_url().  $this->common->showImageAdmin('../uploads/product/',$value['main_image']);?>" style="width:100px; height:auto"></td>
...
if ($status == "2") {echo '<span class="badge badge-danger  w-25">Inactive</span>';}
      ?></td>
                                        <td><a href="<?php echo site_url($controller.'/productlist?cat_id='.$value['id'])?>" class="list-icons-item text-primary-600" data-popup="tooltip" title="List of products" data-container="body"><i class="icon icon-list2"></i></a> | <a href="<?php echo site_url($controller.'/categor_action/'.$value['id'])?>" class="list-icons-item text-primary-600" data-popup="tooltip" title="Edit" data-container="body"><i class="icon-pencil7"></i></a>
        ...
        bootbox.confirm({
            ...
            callback: function(result) {
                if (result) {
                    ...
                    location.href = "<?php echo site_url($controller . '/categor_action_delete/') ?>" + uuid;
