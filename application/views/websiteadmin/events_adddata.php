    ...
    ?>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" id="blogform1" name="blogform1" method="post" action="<?php echo site_url($controller.'/'.$fun_name)?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="location">Location <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control alhanumeric1 maxlength-textarea" maxlength="150" name="location" id="location" value="<?php echo isset($records['location']) ? $records['location'] : ''; ?>" placeholder="Location">
                                        <span class="form-text text-muted">Vidyavihar - Mumbai</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                <?php
                                        $featured_image = (isset($records['featured_image']) && $records['featured_image']!="") ? base_url()."uploads/events/".$records['featured_image'] : 'https://via.placeholder.com/100x100' ;
                                    ?>
