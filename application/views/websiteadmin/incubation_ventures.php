                                    ...
                                    <?php
                                      ...
                                      foreach($results as $key => $value){
                                          ...
                                          $status = 1;//$this->common->getDbValue($value['status_flag']);
                                           ...
                                           $pdf_file = (isset($value['pdf_file']) && $value['pdf_file']!="") ? base_url()."uploads/cms/incubation/".$value['pdf_file'] : '' ;
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        ...
                        location.href = "<?php echo site_url($controller . '/delete_data_incubation_ventures/') ?>" + uuid;
