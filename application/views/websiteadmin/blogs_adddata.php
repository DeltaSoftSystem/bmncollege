                    ...
                    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                        ...
                        <div class="header-elements d-none">
                            <div class="breadcrumb justify-content-center">
                                <a href="<?php echo site_url($controller . "/bloglist"); ?>" class="breadcrumb-elements-item">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" id="blogform1" name="blogform1" method="post" action="<?php echo site_url($controller.'/'.$fun_name)?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="newsblogs_cat_id">Category <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <div class=" row">
                                            <div class="col-lg-6">
                                                <select name="newsblogs_cat_id" id="newsblogs_cat_id" class="form-control col-lg-6 form-control-select2" data-fouc>
                                                    <?php  $this->services->get_categorylist_parent_sub((isset($records['newsblogs_cat_id']))?$records['newsblogs_cat_id']:'0')?>

                                                </select>
                                                <div class="hidedefault validation-invalid-label mt-2" id="error_newsblogs_cat_id">Please select </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="heading">Blog Title <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control alhanumeric1 maxlength-textarea" maxlength="225" name="heading" id="heading" value="<?php echo isset($records['heading']) ? $records['heading'] : ''; ?>" placeholder="Blog Title">
                                    </div>
                                </div>
                                <div class="form-group row">
                                <?php
                                      $featured_image = (isset($records['featured_image']) && $records['featured_image']!="") ? base_url()."../uploads/blogs/".$records['featured_image'] : 'http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image'; ;
                                    ?>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="<?php echo site_url("blogs/bloglist");?>"><button type="button" class="btn btn-light" id="reset"><i class="icon-arrow-left7"></i> Back</button></a>
