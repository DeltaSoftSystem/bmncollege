...
<head>
	...
	<!-- Theme JS files -->
	<script src="<?php echo base_url()?>websiteadmin/global_assets/js/plugins/editors/ckeditor/ckeditor.js"></script>
                    ...
                    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                        ...
                        <div class="header-elements d-none">
                            <div class="breadcrumb justify-content-center">
                                <a href="<?php echo site_url($this->controller."/list_all");?>" class="breadcrumb-elements-item">
...
<form action="<?php echo site_url($this->controller.'/edit_setting/'.$id)?>" name="ed_pg_frm" id="ed_pg_frm" method="post" class="form-horizontal" enctype="multipart/form-data">
<input type="hidden" name="mode_edt" id="mode_edt" value="edit_att">

                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="name">Key :</label>
                                    <div class="col-lg-9"><input type="text" class="form-control" id="username" name="username" disabled placeholder="Key" value="<?php echo $this->common->getDbValue($sel_rs['key_name'])?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <a href="<?php echo site_url($this->controller.'/list_all')?>"><button type="button" class="btn btn-light  ml-2">Cancel</button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
