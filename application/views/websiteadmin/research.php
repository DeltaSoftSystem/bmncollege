                                ...
                                <tbody>
                                    <?php
                                     ...
                                     <tr class="  border-left-3  <?php echo ($status == "Active") ? 'border-left-success' : 'border-left-danger' ?>  tr<?php echo $this->common->getDbValue($value['status_flag']); ?>">
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $this->common->getDbValue($value['data_type']); ?></td>
                                        <td><?php echo $this->common->getDbValue($value['date_year']); ?></td>
                                        <td><?php echo $this->common->getDbValue($value['heading']); ?></td>
                                        <td><?php if($value['main_image']!=''){
			  	$photo = base_url() . '/uploads/cms/research/'.stripslashes($value['main_image']);
?>
                                        ...
                                        <td> 
                                            <?php
if ($status == "Active") {echo '<span class="badge badge-success  w-1001">Active</span>';}
      ?>
                                            <?php
if ($status != "Active") {echo '<span class="badge badge-danger  w-1001">Inactive</span>';}
      ?></td>
                                        <td><a href="<?php echo site_url($edit_link.'/'.$value['uuid'])?>" class="list-icons-item text-primary-600" data-popup="tooltip" title="Edit" data-container="body"><i class="icon-pencil7"></i></a>
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        ...
                        location.href = "<?php echo site_url($controller . '/delete_data_research/') ?>" + uuid;
