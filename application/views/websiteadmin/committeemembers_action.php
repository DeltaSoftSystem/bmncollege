                       ...
                       // print_r($records);
                        ...
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="data_type"> Member of :</label>
                                <div class="col-lg-9">
                                    <select name="data_type" id="data_type" class="form-control" aria-label="Default select example">
                                        <option value="Committee Members of B. Sc. Home Science" <?php echo (isset($records['data_type']) && $records['data_type']=="Committee Members of B. Sc. Home Science") ? ' selected' : ''?>>Committee Members of B. Sc. Home Science</option>
                                        <option value="Committee Members of Smt. K. G. Shah Department of Computer Applications" <?php echo (isset($records['data_type']) && $records['data_type']=="Committee Members of Smt. K. G. Shah Department of Computer Applications") ? ' selected' : ''?>>Committee Members of Smt. K. G. Shah Department of Computer Applications
 </option>
                                        <option value="M. Sc. CND" <?php echo (isset($records['data_type']) && $records['data_type']=="M. Sc. CND") ? ' selected' : ''?>>M. Sc. CND
 </option>
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="heading"> Name :</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control alhanumeric1 maxlength-textarea"
                                        name="heading" id="heading" maxlength="200"
                                        value="<?php echo isset($records['heading']) ? $records['heading'] : ''; ?>"
                                        placeholder="Name" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="post_name"> Type :</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control alhanumeric1 maxlength-textarea"
                                        name="post_name" id="post_name" maxlength="200"
                                        value="<?php echo isset($records['post_name']) ? $records['post_name'] : ''; ?>"
                                        placeholder="In-charge" required>
                                </div>
                            </div>
