                        ...
                        <div class="card-body">
                            <form class="form-horizontal" id="blogform1" name="blogform1" method="post" action="<?php echo site_url($controller.'/'.$fun_name)?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="full_name">Name </label>
                                    <div class="col-lg-10">
                                        <div class=" row">
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control alhanumeric1 maxlength-textarea" maxlength="250" name="name" id="name" value="<?php echo isset($records['full_name']) ? $records['full_name'] : ''; ?>" placeholder="First name" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="email_addrress">Email </label>
                                    <div class="col-lg-10">
                                        <div class=" row">
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control alhanumeric1 maxlength-textarea" maxlength="250" name="email_addrress" id="email_addrress" value="<?php echo isset($records['email_addrress']) ? $records['email_addrress'] : ''; ?>"     readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="contact_number">Phone </label>
                                    <div class="col-lg-10">
                                        <div class=" row">
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control alhanumeric1 maxlength-textarea" maxlength="250" name="contact_number" id="contact_number" value="<?php echo isset($records['contact_number']) ? $records['contact_number'] : ''; ?> "  readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="city">Phone </label>
                                    <div class="col-lg-10">
                                        <div class=" row">
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control alhanumeric1 maxlength-textarea" maxlength="250" name="city" id="city" value="<?php echo isset($records['city']) ? $records['city'] : ''; ?> "  readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="program">Detail </label>
                                    <div class="col-lg-10">
                                        <textarea name="program" id="program" class="form-control " rows="2" cols="2" readonly><?php echo isset($records['program']) ? $records['program'] : ''; ?></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    ?>
                                    <label class="col-lg-2 col-form-label">Replied Status <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
