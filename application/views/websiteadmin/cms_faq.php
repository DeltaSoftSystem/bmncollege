                ...
                <div class="page-header page-header-light">
                    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                        ...
                        <div class="breadcrumb justify-content-center">
                                <a href="<?php echo site_url($controller . "/faq_action"); ?>" class="breadcrumb-elements-item">
    ...
    foreach ($results as $key => $value) {
        ...
        ?>
                                <tr >
                                    ...
                                    <td class="text-center"><?php $status = $this->common->getDbValue($value['status_flag']);?>
                                        <?php
if ($status == "1") {echo '<span class="badge badge-success">Active</span>';}
        ?>
                                        <?php
if ($status == "0") {echo '<span class="badge badge-light">Inactive</span>';}
        ?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?php echo site_url($controller.'/faq_action/'.$value['id'])?>" class="list-icons-item text-primary-600" data-popup="tooltip" title="Edit" data-container="body"><i class="icon-pencil7"></i></a>
        ...
        bootbox.confirm({
            ...
            callback: function(result) {
                if (result) {
                    ...
                    location.href = "<?php echo site_url($controller . '/faq_action_delete/') ?>" + uuid;
