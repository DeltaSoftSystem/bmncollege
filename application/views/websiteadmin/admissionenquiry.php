                        ...
                        <div class="header-elements d-none">
                            <div class="breadcrumb justify-content-center">
                                <a href="<?php echo site_url($download_link ); ?>" class="breadcrumb-elements-item">
                                    <button type="button" class="btn bg-purple btn-sm"><i class="icon-file-excel"></i> Download</button>
                                </a>
                                ...
                                <tbody>
                                    <?php
                                     ...
                                     <tr class="  border-left-3  <?php echo ($status == "1") ? 'border-left-success' : 'border-left-danger' ?>  tr">
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $this->common->getDbValue($value['full_name']); ?></td>
                                        <td><?php echo $this->common->getDbValue($value['email_addrress']); ?></td>
                                        <td><?php echo $this->common->getDbValue($value['contact_number']); ?> </td>
                                        <td><?php echo $this->common->getDbValue($value['program']); ?> </td>
                                        
                                        <td><?php echo isset($value['add_date']) ? $this->common->getDateFormat($value['add_date'], DATE_FORMAT_PHP) : ''; ?></td>
                                        <td> 
                                            <?php
if ($status == "1") {echo '<span class="badge badge-success  w-25">New</span>';}
      ?>
                                            <?php
if ($status == "2") {echo '<span class="badge badge-danger  w-25">Read</span>';}
      ?></td>
