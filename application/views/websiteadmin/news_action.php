...
if ($error) {
    ?>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" id="blogform1" name="blogform1" method="post" action="<?php echo site_url($controller.'/'.$fun_name)?>" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="heading_old" id="heading_old" value="<?php echo isset($records['heading']) ? $records['heading'] : ''; ?>">
                                <input type="hidden" name="sort_no" id="sort_no" value="<?php echo isset($records['sort_no']) ? $records['sort_no'] : ''; ?>" >
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="heading">Title/Heading <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control alhanumeric1 maxlength-textarea" maxlength="225" name="heading" id="heading" value="<?php echo isset($records['heading']) ? $records['heading'] : ''; ?>" placeholder="Title">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="blogger_name">Posted By <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control alhanumeric1 maxlength-textarea" maxlength="225" name="blogger_name" id="blogger_name" value="<?php echo isset($records['blogger_name']) ? $records['blogger_name'] : ''; ?>" placeholder="Posted By">
                                        <span class="form-text text-muted">DR. BMN College of Home Science</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="event_dates">Date <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                    <input type="text" class="form-control alhanumeric1 "
                                        name="event_dates" id="event_dates"
                                        value="<?php echo isset($records['event_dates']) ? $records['event_dates'] : ''; ?>"
                                        placeholder="Date">
                                    </div>
                                </div>
                                 <div class="form-group row">
                                <?php
                                        $featured_image = (isset($records['featured_image']) && $records['featured_image']!="") ? base_url()."uploads/news/".$records['featured_image'] : 'https://via.placeholder.com/100x100' ;
                                    ?>
                                    <label class="col-md-2 col-form-label">  Image</label>
                                    <div class="col-md-10">
                                        <div class="row col-md-5">
                                            <img src="<?php echo $featured_image?>" id="temppreviewimageki1" class="temppreviewimageki1" style="width:100px; height:auto;display:none1">
                                ...
                                <div class="col-lg-10">
                                    <div class=" row">
                                        <div class="col-lg-6">
                                            ...
                                            <span class="form-text text-muted">Accepted Formats: pdf, Max File Size 24mb </span>

                                            <?php
                                
                                $pdf_file = (isset($records['pdf_file']) && $records['pdf_file']!="") ? base_url()."uploads/news/".$records['pdf_file'] : '' ;
                                                if($pdf_file!=""){
                              ?>
                               ...
                               <!-- <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <a href="<?php echo site_url($back_link);?>"><button type="button" class="btn btn-light" id="reset"><i class="icon-arrow-left7"></i> Back</button></a>
 ...
 function sendFile(file) {
     //alert("ddd");
         ...
         upload_url = "<?php echo site_url('websiteadmin/summernote/upload_image'); ?>" ;
         $.ajax({
             data: data,
             type: "POST",
             url: upload_url,
    ...
    $(document).ready(function() {
        ...
        $("#error_status_flag").hide();
         $("#blogform1").submit(function(e) {
            ...
            if (!$("#blogger_name").val()) {
                isError = true;
                $("#blogger_name").addClass("border-danger");
               
            }
            if (!$("#event_dates").val()) {
                isError = true;
                $("#event_dates").addClass("border-danger");
