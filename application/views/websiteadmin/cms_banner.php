    ...
    ?>
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-tabs-bottom">
                            <li class="nav-item"><a href="<?php echo site_url('cms/homepage?tab=1') ?>" class="nav-link <?php echo (isset($tab1)) ? 'active' : ''?>" data-toggle1="tab">Hello
                                    Bar</a></li>
                            <li class="nav-item"><a href="<?php echo site_url('cms/banner') ?>" class="nav-link active" data-toggle1="tab">Slider</a>
                            </li>
                            <li class="nav-item"><a href="<?php echo site_url('cms/homepage?tab=3') ?>" class="nav-link" data-toggle1="tab">Section 1
                                    (Box 3)</a></li>
                            <li class="nav-item"><a href="<?php echo site_url('cms/homepage?tab=4') ?>" class="nav-link" data-toggle1="tab">Section 2
                                    (Box 6)</a></li>
                            <li class="nav-item"><a href="<?php echo site_url('cms/homepage?tab=5') ?>" class="nav-link" data-toggle1="tab">Section
                                    3</a></li>
                            <li class="nav-item"><a href="<?php echo site_url('cms/homepage?tab=6') ?>" class="nav-link" data-toggle1="tab">Section
                                    4</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="Section-tab2">
                            <?php
