...
if ($warning) {
    ?>
                            ...
                            <table class="table table-hover datatable-responsive">
                                ...
                                <thead>
                                    <tr class="bg-blue">
                                        ...
                                        <th>Heading</th>
                                        <?php
                            if($this->uri->segment(4)!="PGECE-programm"){
                            ?>
                                        <th>Image</th>
                                        <?php }?>
                                        <th>Status</th>
			  	...
			  	$photo = base_url() . '/uploads/cms/programme/'.stripslashes($value['main_image']);
?>
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        ...
                        location.href = "<?php echo site_url($controller . '/delete_data_ug_common/'.$menu_name.'/'.$redirectto) ?>/" + uuid;
