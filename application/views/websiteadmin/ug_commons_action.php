                    ...
                    <div class="card-body">
                       ...
                       // print_r($records);
                        ...
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <?php
                            if($this->uri->segment(4)=="PGDSSFN-programm"){
                            ?>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="date_eevents"> Date </label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control alhanumeric1 maxlength-textarea"
                                        name="date_eevents" id="date_eevents" maxlength="512"
                                        value="<?php echo isset($records['date_eevents']) ? $records['date_eevents'] : ''; ?>"
                                        placeholder="3rd December, 2021" >
                                        <span class="form-text text-muted">Date entry manually like 3rd December, 2021</span>
                                </div>
                            </div>
                            <?php    
                            }
                            ?>
                            <?php
                            //$this->uri->segment(4)!="PGECE-programm"
                            if(1){
                            ?>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <?php
                                      $main_image = (isset($records['main_image']) && $records['main_image']!="") ? base_url()."uploads/cms/programme/".$records['main_image'] : 'https://via.placeholder.com/100x100'; ;
                                    ?>
                            ...
                            <div class="form-group row">
                                ...
                                $pdf_file = (isset($records['pdf_file']) && $records['pdf_file']!="") ? base_url()."uploads/cms/programme/".$records['pdf_file'] : '' ;
                                                if($pdf_file!=""){
                              ?>
