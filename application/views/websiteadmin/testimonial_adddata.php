                        ...
                        <div class="card-body">
                            <form class="form-horizontal" id="blogform1" name="blogform1" method="post" action="<?php echo site_url($controller.'/'.$fun_name)?>" enctype="multipart/form-data">
                                ...
                                <?php
                                      ...
                                      $from_image = (isset($records['from_image']) && $records['from_image']!="") ? base_url()."uploads/testimonials/".$records['from_image'] : 'https://via.placeholder.com/100x100'; ;
                                    ?>
                                    <label class="col-md-2 control-label">  Pic</label>
                                    <div class="col-md-10">
                                        <div class="row col-md-5">
                                            <img src="<?php echo $from_image?>" id="temppreviewimageki1" class="temppreviewimageki1" style="width:100px; height:auto;display:none1">
