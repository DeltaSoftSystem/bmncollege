    ...
    foreach ($results as $key => $value) {
        ...
        ?>
                                <tr
                                    ...
                                    <td><?php echo $this->common->getDbValue($value['user_email']); ?></td>
                                  
                                    <td><?php echo isset($value['add_date']) ? $this->common->getDateFormat($value['add_date'], DATE_FORMAT_PHP) : ''; ?>
                                    </td>
                                     
                                    <td><?php $status_flag = $this->common->getDbValue($value['status_flag']);?>
                                        <?php
if ($status_flag == "Active") {echo '<span class="badge badge-success">Active</span>';}
        ?>
                                        <?php
if ($status_flag == "Inactive") {echo '<span class="badge badge-light">Inactive</span>';}
        ?>
                                    ...
                                    <td class="text-center">
                                        <div class="list-icons">
                                            ...
                                            <a href="<?php echo site_url($controller . '/editdata/' . $value['uuid']) ?>"
                                                class="list-icons-item text-primary-600" data-popup="tooltip" title=""
                                                kisdata-original-title1="Edit"><i class="icon-pencil7"></i></a>
                                            <?php
                                            if($value['user_id']!=1){
                                            ?>
                                            <a href="#" class="list-icons-item text-danger-600 bootbox_custom"
                                                data-uuid="<?php echo $value['uuid'] ?>" data-popup="tooltip" title=""
                                                kisdata-original-title1="Delete"><i class="icon-trash"></i></a>
                                            <?php }?>
                                        </div>
                                    </td>
                                </tr>
