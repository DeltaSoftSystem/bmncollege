    ...
    ?>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                <?php
                                      $featured_image = (isset($records['featured_image']) && $records['featured_image']!="") ? base_url()."uploads/cms/incubation/".$records['featured_image'] : 'https://via.placeholder.com/100x100'; ;
                                    ?>
