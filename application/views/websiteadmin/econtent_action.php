                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="name">Title/Heading <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control alhanumeric1 "
                                         name="title_name" id="title_name"
                                        value="<?php echo isset($records['title_name']) ? $records['title_name']  : ''; ?>"
                                        placeholder="Title/Heading">
                                </div>
                                
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="descriptions">Detail <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <textarea name="descriptions" rows="7" id="descriptions" class="form-control" ><?php echo isset($records['descriptions']) ? $records['descriptions'] : ''; ?></textarea>
                                </div>
                                
                            </div>
                            <div class="form-group row">
                                <?php
                                      $featured_image = (isset($records['featured_image']) && $records['featured_image']!="") ? base_url()."uploads/cms/econtent/".$records['featured_image'] : 'https://via.placeholder.com/100x100'; ;
                                    ?>
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <div class="btn btn-default image-preview-input">
                                                    ...
                                                    <input type="file" accept="image/png, image/jpeg, image/gif"
                                                        class="browseimage" id="1" name="featured_image" />
                                                    <!-- rename it -->
                            ...
                            <div class="form-group row">
                                ...
                                $pdf_file = (isset($records['pdf_file']) && $records['pdf_file']!="") ? base_url()."uploads/cms/econtent/".$records['pdf_file'] : '' ;
                                                if($pdf_file!=""){
                              ?>
...
$(document).ready(function() {
    ...
    $("#blogform1").submit(function(e) {
        ...
        if (!$("#title_name").val()) {
            isError = true;
            $("#title_name").addClass("border-danger");
