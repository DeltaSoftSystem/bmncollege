                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="semester">For :</label>
                                <div class="col-lg-9">
                                    <?php
                                    $degree_year_master[]='Freshers';
                                    $degree_year_master[]='Repeaters';
                                    ?>
                                    <select name="semester" id="semester" class="form-control" aria-label="Default select" required>
                                        <option value="">Select</option>
                                        <?php
                                        foreach($degree_year_master as $key => $value) {
                                        ?>
                                        <option value="<?php echo $value?>" <?php echo (isset($records['semester']) && $records['semester']==$value) ? ' selected' : ''?>><?php echo $value?></option>
                                         <?php }?>
                                    </select>
                                </div>
                            </div>
