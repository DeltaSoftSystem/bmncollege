                                    ...
                                    <?php
                                      ...
                                      foreach($results as $key => $value){
                                          ...
                                          $status = 1;//$this->common->getDbValue($value['status_flag']);
                                           ...
                                           $pdf_file = (isset($value['pdf_file']) && $value['pdf_file']!="") ? base_url()."uploads/cms/econtent/".$value['pdf_file'] : '' ;
                                     ...
                                     <tr class="  border-left-3  <?php echo ($status == "1") ? 'border-left-success' : 'border-left-danger' ?>  tr<?php echo $this->common->getDbValue($value['status_flag']); ?>">
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $this->common->getDbValue($value['title_name']); ?></td>
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        ...
                        location.href = "<?php echo site_url($controller . '/delete_data_econtent/') ?>" + uuid;
