                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="name">Name <span
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="venture_name">Venture <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control alhanumeric1 "
                                         name="venture_name" id="venture_name"
                                        value="<?php echo isset($records['venture_name']) ? $records['venture_name']  : ''; ?>"
    ...
    $(document).ready(function() {
        ...
        $("#error_status_flag").hide();
         $("#blogform1").submit(function(e) {
            ...
            if (!$("#venture_name").val()) {
                isError = true;
                $("#venture_name").addClass("border-danger");
