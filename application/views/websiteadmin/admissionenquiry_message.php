                        ...
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                     ...
                                     //  print_r($records);
                                        ?>
                                        <textarea name="descriptions" rows="2" style="height:200px;" id="descriptions"class="form-control summernote" ><?php echo isset($records['value']) ? $records['value'] : ''; ?></textarea>
