...
<!-- <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog page_load">
        <div class="modal-content">
            <div class="pop_title">
                <h5 class="admission_title">ADMISSIONS OPEN</h5>
    ...
    <div class="modal-dialog page_load">
        <div class="modal-content">
            ...
            <div class="pop_call">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="pop_phone"><i class="fa fa-phone" aria-hidden="true"></i><a href="callto:9867997415">9867997415</a></div>
                    </div>
                    <div class="col-sm-6">
                        <div class="pop_phone"><i class="fa fa-envelope enve lop" aria-hidden="true"></i> <a
                                href="mailto:admission@bmncollege.com">khan@bmncollege.com</a></div> 
                    </div>
                </div>
            </div>
