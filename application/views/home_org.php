                        ...
                        <ul>
                            ...
                            <li><a href="#"><i class="fa fa-desktop" aria-hidden="true"></i> <?php echo $this->lang->line("NIRF");?>
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">2023</a>
                                        <ul>
                                            <li><a href="<?php echo base_url();?>uploads/pdf/NIRF 2023 COLLEGE - Dr. Bhanuben Mahendra Nanavati College of Home Science20230103-.pdf"
                                                    target="_blank">College 2023</a></li>
                                            <li><a href="<?php echo base_url();?>uploads/pdf/NIRF 2023 OVERALL - Dr. Bhanuben Mahendra Nanavati College of Home Science.pdf"
...
?>
                            <li ><a href="#<?php echo base_url();?><?php echo $academicCalendar?>"
                             ...
                             <ul>
                                    ...
                                    <li><a href="<?php echo base_url();?>uploads/pdf/ACADEMIC CALENDAR  (June 2023 - May 2024)dated 4th jan.pdf" target="_blank"><?php echo $this->lang->line("2023-2024");?> </a></li>
 ...
 <li class="mobile_menu_on sub"><a href="<?php echo base_url();?>uploads/pdf/2020 - 2021 ACADEMIC CALENDAR.pdf" target="_blank"><i class="fa fa-angle-right"
                                    ...
                                    <li class="mobile_menu_on sub"><a href="<?php echo base_url();?>uploads/pdf/ACADEMIC CALENDAR  (June 2023 - May 2024).pptx" target="_blank"><i class="fa fa-angle-right"
                                        aria-hidden="true"></i> <?php echo $this->lang->line("2023-2024");?> </a></li>
